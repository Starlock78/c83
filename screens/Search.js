...
//2 importar la base de datos que se llama comfig
...
export default class SearchScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      //mostrar como vaciar allTransaction
      allTransactions: [],
      searchText: ""
    };
  }
...
//3 Funsion que muestra los datos de transacciones.
  getTransactions = () => {
...
//4 flat list enumera todas las transacciones en data, renderItem, keyExtractor
  renderItem = ({ item, i }) => {
    var date = item.date
      .toDate()
      .toString()
...
//5 función que hara la consulta de busqueda de los datos
handleSearch = async text => {
  var enterededText = text.toUpperCase().split("");
